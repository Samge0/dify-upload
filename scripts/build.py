...
def build():
    ...
    # 复制并重命名配置文件
    example_config_path = "difys/configs.demo.py"
    ...
    pyinstaller_cmd = [
        ...
        "--onefile",
        # 直接添加需要的文件和目录
        "--add-data", f"difys{path_separator}difys",
        ...
        "--add-data", f"{temp_config_path}{path_separator}difys",
        # 添加必要的依赖
    ...
    if platform.system().lower() == "darwin":
        ...
        pyinstaller_cmd.extend([
            "--name", OUTPUT_NAME,
            "--osx-bundle-identifier", "com.dify.upload",
